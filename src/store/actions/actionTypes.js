...
export const YARATILAN_ODA_ADI ='YARATILAN_ODA_ADI';
export const GIRILEN_ODA_ADI ='GIRILEN_ODA_ADI';
export const KAVUSMA ='KAVUSMA';
    ...
    return (dispatch, getState) => {
        if (getState().current_user) {
            ...
            axios({
                ...
                .catch(err => {
                    console.error(
                        "There was an error getting recently played tracks"
                    );
                });
        }
    };
